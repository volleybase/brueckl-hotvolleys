...
var option = {
  data: {
    'window.editor.graphics.actor.ActorImpl.option.attack2': false,
    'window.editor.graphics.actor.ActorImpl.option.short-target-4': false,
    'window.editor.graphics.actor.ActorImpl.option.middle-target-4': false,
    'window.editor.graphics.actor.ActorImpl.option.long-target-2': false,
    'window.editor.graphics.actor.ActorImpl.option.long-target-4': false,
    'window.editor.graphics.actor.ActorImpl.option.middle-net-target-4': false,
    'window.editor.graphics.actor.ActorImpl.option.attack4': true,
    'window.editor.graphics.actor.ActorImpl.option.middle-net-target-2': false,
    'window.editor.graphics.actor.ActorImpl.option.short-target-2': false,
    'window.editor.graphics.actor.ActorImpl.option.middle-target-2': false
  },
