...
function showContextMenu(x, y) {
  ...
  if (!contextmenu) {
    ...
    cm.setAttribute('transform', 'translate(' + svgP.x + ' ' + svgP.y + ') scale(0.945)');
  }
}
...
var animation0 = {
  ...
  "draw_5": {
    "draw": [
      ...
      {
        "dx": -88.63269777109872,
        "dy": 15.628335990023725,
        "angle": -10.0,
        "length": -90.0,
        "visible": true,
        "predecessor": 4
