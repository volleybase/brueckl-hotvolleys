...
function showContextMenu(x, y) {
  ...
  if (!contextmenu) {
    ...
    cm.setAttribute('transform', 'translate(' + svgP.x + ' ' + svgP.y + ') scale(0.225)');
  }
}
...
var animation0 = {
  "draw_1": {
    "draw": [
      ...
      {
        "dx": 13.680805733026753,
        "dy": 37.587704831436334,
        "angle": 70.0,
        "length": 40.0,
        "visible": true,
        "predecessor": 5
      ...
      {
        "dx": 22.98133329356934,
        "dy": 19.283628290596177,
        "angle": 40.0,
        "length": 30.0,
        "visible": true,
        "predecessor": 6
