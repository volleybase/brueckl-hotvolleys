...
function showContextMenu(x, y) {
  ...
  if (!contextmenu) {
    ...
    cm.setAttribute('transform', 'translate(' + svgP.x + ' ' + svgP.y + ') scale(0.24)');
  }
}
...
var animation = {
  ...
  "path_2": [
    ...
    },
    {
      ...
      "y": 0.0,
      "mode": "linear",
      "start": 2.1000001430511475,
      "end": 2.3000001460313797
    },
    {
      "type": "mov",
      "x": -10.0,
  ...
  "path_4": [
    {
      ...
      "y": 0.0,
      "mode": "linear",
      "start": 0.9000000357627869,
      "end": 1.100000038743019
    },
    {
      "type": "mov",
      "x": 10.0,
    ...
    },
    {
      ...
      "end": 3.7999999076128006
    }
  ],
  "ellipse_5": [
    {
      "type": "mov",
      "x": -101.66009111552485,
      "y": -0.3581884311808503,
      "mode": "parable",
      "angle": 1.7470745812463238,
      "speed": 1.7,
      "slowmo": 2.0,
      "start": 0.4,
      "end": 1.082
    ...
    {
      "type": "mov",
      "x": 101.66009111552493,
      "y": -0.3581884311808503,
      "mode": "parable",
      "angle": 1.3945180723434694,
      "speed": 1.7,
      "slowmo": 2.0,
      "start": 1.6,
      "end": 2.282
  ...
  "ellipse_6": [
    {
      "type": "mov",
      "x": 10.56821311134282,
      "y": 0.3728686685649518,
      "mode": "parable",
      "angle": 1.5376350710070041,
      "speed": 1.25,
      "slowmo": 2.0,
      "start": 0.0,
      "end": 0.51
...
animator.initAnimation(3.6, 1.2);